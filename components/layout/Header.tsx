      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex flex-col leading-none" onClick={closeMenu}>
             <span className={`font-display font-extrabold text-3xl tracking-tight ${isHome ? 'text-white' : 'text-brand-blue'}`}>T98</span>
             <span className={`font-display font-bold text-sm ${isHome ? 'text-white/80' : 'text-brand-orange'}`}>Rehab & Chiropractic</span>
          </Link>
